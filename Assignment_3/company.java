...
class Programmer extends Employee
{
    ...
    static void search(Programmer arr[], int key, int n)
    {
        for(int i=0;i<n;i++)
        {
            if (arr[i].employee_id==key)
            {
                System.out.println("EMPLOYEE FOUND");
                arr[i].display_employee_info();
                arr[i].display_employee_salary_slip();
            }
            else
            {
...
class AssistantProjectManager extends Employee
{
    ...
    static void search(AssistantProjectManager arr[], int key, int n)
    {
        for(int i=0;i<n;i++)
        {
            if (arr[i].employee_id==key)
...
class ProjectManager extends Employee
{
    ...
    static void search(ProjectManager arr[], int key, int n)
    {
        for(int i=0;i<n;i++)
        {
            if (arr[i].employee_id==key)
